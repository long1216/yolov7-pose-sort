...
def plot_one_box(x, im, color=None, label=None, line_thickness=3, kpt_label=False, kpts=None, kpts_conf=0.5, steps=2, orig_shape=None):
    ...
    if kpt_label:
        plot_skeleton_kpts(im, kpts, steps, kpts_conf, orig_shape=orig_shape)

def plot_one_box_track():

    return


def plot_skeleton_kpts(im, kpts, steps, confidence, orig_shape=None):
